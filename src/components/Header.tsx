...
<header className="flex flex-col w-full">
    <section id="Hero-Banner" className="relative flex h-[720px] -mb-[93px]">
        <div id="Hero-Text"
            ...
            <div className="flex items-center w-fit rounded-full py-2 px-4 gap-[10px] bg-[#000929]">
                <Image src="/assets/images/icons/crown-white.svg" width={20} height={20} alt="icon" />
            ...
            <div className="flex items-center gap-5">
                <a href="#" className="flex items-center rounded-full p-[20px_26px] gap-3 bg-[#0D903A]">
                    <Image src="/assets/images/icons/slider-horizontal-white.svg" width={30} height={30}
                        alt="icon" />
        ...
        <div id="Hero-Image"
            ...
            <Image fill priority src="/assets/images/backgrounds/banner.webp" className="w-full h-full object-cover"
                alt="hero background" />
        </div>
    </section>
    <div className="flex flex-col pt-[150px] pb-10 px-[120px] gap-10 bg-[#0D903A]">
        <div
            ...
            <Image width={120} height={120} src="/assets/images/logos/TESLA.svg" alt="clients logo" />
            <Image width={120} height={120} src="/assets/images/logos/Libra 2.svg" alt="clients logo" />
            <Image width={120} height={120} src="/assets/images/logos/Binance logo.svg" alt="clients logo" />
            <Image width={120} height={120} src="/assets/images/logos/Facebook 7.svg" alt="clients logo" />
            <Image width={120} height={120} src="/assets/images/logos/Microsoft 6.svg" alt="clients logo" />
        </div>
